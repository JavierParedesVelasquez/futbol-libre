    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                $id = $_REQUEST['id_anuncio3'];
                $sql = "SELECT * FROM anuncio3 WHERE id_anuncio3=$id";
                $resultado = $conexion->query($sql);
                $fila = $resultado->fetch_assoc();
                ?>
                <form action="editarAnuncio3.php?anuncio_id3=<?php echo $fila['id_anuncio3'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel1">
                                ...
                                <div class="panel-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea rows="10" cols="50" type="text" class="form-control" id="txtsrc" value="" name="txtsrc" placeholder="Ingrese titulo de Canal" ><?php echo $fila['codigo_anuncio3'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
