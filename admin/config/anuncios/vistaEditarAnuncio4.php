    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                $id = $_REQUEST['id_anuncio4'];
                $sql = "SELECT * FROM anuncio4 WHERE id_anuncio4=$id";
                $resultado = $conexion->query($sql);
                $fila = $resultado->fetch_assoc();
                ?>
                <form action="editarAnuncio4.php?anuncio_id4=<?php echo $fila['id_anuncio4'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel1">
                                ...
                                <div class="panel-body">
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Introducir Codigo html / script:Codigo Imagen:</label>
                                        <textarea rows="10" cols="50" type="text" class="form-control" id="txtsrc" value="" name="txtsrc" placeholder="Ingrese titulo de Canal" ><?php echo $fila['codigo_anuncio4'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
