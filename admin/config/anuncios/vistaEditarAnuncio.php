    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                $id = $_REQUEST['id_anuncio1'];
                $sql = "SELECT * FROM anuncio1 WHERE id_anuncio1=$id";
                $resultado = $conexion->query($sql);
                $fila = $resultado->fetch_assoc();
                ?>
                <form action="editarAnuncio.php?anuncio_id1=<?php echo $fila['id_anuncio1'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel1">
                                <div class="panel-heading d-flex pb-3">
                                    <i class="fa-sharp fa-solid fa-bullhorn"></i>
                                    <h3>Editar Anuncio 1:</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Introducir Codigo html / script:</label>
                                        <textarea rows="10" cols="50"  class="form-control" id="txtsrc" value="" name="txtsrc" placeholder="Ingrese titulo de Canal" ><?php echo $fila['codigo_anuncio1'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
